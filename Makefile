...
CXXFLAGS      = -m64 -pipe -Wextra -Wno-unused-variable -Wno-unused-parameter -O2 -o3 -std=gnu++1y -Wall -W -D_REENTRANT -fPIC $(DEFINES)
...
COMPRESS      = gzip -9f
DISTNAME      = rsd1.0.0
DISTDIR = /home/ztaal/Desktop/logger/.tmp/rsd1.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h myThread.hpp logger.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp myThread.cpp logger.cpp $(DISTDIR)/
...
moc_myThread.cpp: myThread.hpp \
		/usr/lib/x86_64-linux-gnu/qt5/bin/moc
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/home/ztaal/Desktop/logger -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/6 -I/usr/include/x86_64-linux-gnu/c++/6 -I/usr/include/c++/6/backward -I/usr/lib/gcc/x86_64-linux-gnu/6/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/6/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include myThread.hpp -o moc_myThread.cpp
